...
- Mostrar ao representante somente **Expediente**, **Produtos** e **Clientes** no menu. A quantidade de produtos disponíveis no estoque deve ser visível.
...
- Remover do Expediente do representante os blocos de venda rápida, preservando jornada, consentimento e GPS.

### 2. Catálogo para o representante

- Exibir o catálogo central da Matriz em modo somente leitura.
- Mostrar nome e preço de venda, com quantidade em estoque,  sem mostrar custo, alerta de estoque, edição, exclusão, exportação ou reposição inteligente.
...
- Incluir no cliente selecionado a ação de registrar pedido agendado, com produto do catálogo da Matriz, quantidade, preço (editável) e data de entrega.
...
- Acrescentar ao cliente os campos de CPF/CNPJ e endereço estruturado.
